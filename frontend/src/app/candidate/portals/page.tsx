    ...
    <div className="space-y-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="max-w-2xl space-y-3">
          ...
          <div className="flex gap-3 rounded-xl border border-emerald-500/30 bg-emerald-500/10 px-3 py-2.5 text-sm text-emerald-900 dark:text-emerald-100">
            <ShieldCheck className="mt-0.5 size-4 shrink-0 text-emerald-600 dark:text-emerald-400" />
            <p>
              <span className="font-medium text-emerald-950 dark:text-emerald-50">Your password is encrypted.</span>{" "}
              We never store portal credentials in plain text, and we never show your password
              back in the app. Only the encrypted value is saved so AutoApply can sign in on
              your behalf.
            </p>
          </div>
        </div>
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          ...
          <DialogContent className="sm:max-w-md">
            <DialogHeader>
              ...
              <DialogDescription>
                Enter your credentials for the selected job portal. Your password is encrypted
                before it is saved — never stored in plain text, never shown back to you.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-2">
              ...
              <p className="flex gap-2 text-xs leading-relaxed text-muted-foreground">
                ...
                Encrypted at rest. Disconnect a portal anytime to delete the saved login.
              </p>
            </div>
